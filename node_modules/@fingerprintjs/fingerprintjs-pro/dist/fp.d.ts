...
declare const ERROR_PROXY_INTEGRATION_SECRET_ENVIRONMENT_MISMATCH: string;
...
declare const _default: {
    ...
    ERROR_HANDLE_AGENT_DATA: string;
    ...
    ERROR_PROXY_INTEGRATION_SECRET_ENVIRONMENT_MISMATCH: string;
